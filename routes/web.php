...
Route::post('/truncate-database', [C_Apriori::class, 'truncateDatabase'])->name('truncate.database');
...
Route::get('/test-apriori', [C_Apriori::class, 'testAutomatedApriori']);//testing
