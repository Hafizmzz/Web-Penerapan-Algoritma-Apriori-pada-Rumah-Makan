<footer class="bg-[#213555] text-white p-3 text-center">
    <p>Hak Cipta © 2025 - Oleh FHK Grup</p>
</footer>
</div>
<!-- end main content-->
...
<!-- <script src="{{ asset('ladun/apaxy/js/datatables.js') }}"></script>
<script src="{{ asset('ladun/apaxy/js/datatables.min.js') }}"></script> -->
